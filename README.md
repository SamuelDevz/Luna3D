...
- XLib (X11): libx11-dev, libxfixes-dev, libxcursor-dev, libpng-dev, libxrandr-dev.
- XCB: libxcb1-dev, libxcb-icccm4-dev, libxcb-xfixes0-dev, libxkbcommon-dev, libxkbcommon-x11-dev, libxcursor-dev, libxcb-keysyms1-dev, libx11-xcb-dev, libpng-dev, libxcb-randr0-dev.
